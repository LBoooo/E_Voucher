...
public class MineBillItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public MineBillItemDecoration(Context context) {
     ...
     */
    public MineBillItemDecoration(Context context, @DrawableRes int drawableId) {
     ...
     */
    public MineBillItemDecoration(Context context, @ColorInt int color, @Dimension float dividerWidth, @Dimension float dividerHeight) {
    ...
    private void init(Context mContext) {
        ...
        mBackgroundPaint.setColor(mContext.getResources().getColor(R.color.backdrop));
    }
